      ...
      try {
        ...
        const eventResult = await sql`
          ...
          VALUES (
            ...
            ${time || null},
            ${location || ''},
            ${originalEventData.venue_name || null},
            ${originalEventData.price},
            ${originalEventData.currency},
            ${originalEventData.is_free},
            ${originalEventData.category},
            ${originalEventData.tags},
            ${originalEventData.max_attendees},
            ${originalEventData.min_attendees},
            ${originalEventData.attendance_required},
            ${name},
            ${device_id},
            ${membership.username},
            'custom',
